...
function App() {
  ...
  const handlePersonSaved = (payload) => {
    ...
    // Delay store update until after the modal has visibly closed so the
    // count-up animation on the affected tiles is actually observable.
    setTimeout(() => addPersonRecord(payload), 320);
  };
